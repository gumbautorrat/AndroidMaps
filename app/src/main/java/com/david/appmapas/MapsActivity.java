...
public class MapsActivity extends FragmentActivity implements View.OnClickListener,OnMapReadyCallback {
    ...
    Button btnMapNormal;
    Button btnMapTerreno;
    Button btnMapHibrido;
    Button btnMapSatelite;
    Button btnInterior;
    Button btnCalcDistance;
    List<LatLng> listPosMarc = new ArrayList<>();
    EditText edTextCalcDistance;
